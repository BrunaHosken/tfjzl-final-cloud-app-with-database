...
def show_exam_result(request, course_id, submission_id):
    ...
    for question in questions:
        correct_choices = question.question_set.filter(is_correct=True)  # Obtenha todas as escolhas corretas para a pergunta
        ...
        if set(correct_choices) == set(selected_choices):
            total_score += question.grade  # Adicione a nota da pergunta somente se todas as respostas corretas forem selecionadas
